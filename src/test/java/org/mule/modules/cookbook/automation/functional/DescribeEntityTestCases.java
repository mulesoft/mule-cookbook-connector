...
public class DescribeEntityTestCases extends AbstractTestCases  {
    ...
    public void testDescribeIngredient() throws CookbookException {
        ...
        assertThat(description.getInnerFields(),
            Matchers.<Description> hasItems(
                    Matchers.hasProperty("name", equalTo("id")),
                    Matchers.hasProperty("name", equalTo("created")),
                    Matchers.hasProperty("name", equalTo("lastModified")),
                    Matchers.hasProperty("name", equalTo("name")),
                    Matchers.hasProperty("name", equalTo("quantity")),
    ...
    public void testDescribeRecipe() throws CookbookException {
        ...
        assertThat(description.getInnerFields(),
                Matchers.<Description> hasItems(
                        ...
                        Matchers.hasProperty("name", equalTo("lastModified")),
                        Matchers.hasProperty("name", equalTo("name")),
                        Matchers.hasProperty("name", equalTo("ingredients")),
                        Matchers.hasProperty("name", equalTo("prepTime")),
                        Matchers.hasProperty("name", equalTo("cookTime")),
                        Matchers.hasProperty("name", equalTo("directions"))
                )
        );
    }
